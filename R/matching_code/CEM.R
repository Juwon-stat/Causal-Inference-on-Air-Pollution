...
run_cem_one <- function(DT, q, region_var, d, cfg) {
  ...
  # IMPORTANT:
  # We only need the union of eligible control month-days.
  # Do not join by target_index × month_day, because that creates a huge
  # cartesian product and can exhaust memory.
